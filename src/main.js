...
import { Tabbar, TabbarItem, Form, Button, Field, NavBar, Picker, Popup, Pagination, SwipeCell } from 'vant';
import { Image as VanImage } from 'vant';
import { Cell, CellGroup } from 'vant';
import { Grid, GridItem, Calendar } from 'vant';
import { Sidebar, SidebarItem, ActionSheet, Overlay, Loading, Notify, Tag, Empty, DatetimePicker } from 'vant';
...
Vue.use(Tag); Vue.use(SwipeCell); Vue.use(Empty); Vue.use(DatetimePicker); Vue.use(List);
